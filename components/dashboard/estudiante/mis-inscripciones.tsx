    ...
    const retirarInscripcion = async (inscripcion: Inscripcion) => { 
      ...
      try { 
        ...
        const res = await fetch( 
          ...
          `/api/estudiante/inscripciones/${inscripcion.id}`, 
        ...
        if (!res.ok) { 
          ...
          toast.error(data.error || "Error al retirar inscripción"); 
        ...
        toast.success( 
          ...
          `Inscripción retirada: ${inscripcion.materia.codigo} - ${inscripcion.materia.nombre}` 
      ...
      return ( 
        ...
        <div className="flex flex-col items-center justify-center py-12 gap-2"> 
          ...
          <p className="text-sm text-muted-foreground"> 
            ...
            Ve al catálogo de materias para inscribirte. 
      ...
      <div className="space-y-4"> 
        ...
        <div className="flex items-center gap-6 text-sm"> 
          ...
          <span> 
            ...
            Créditos activos: <strong>{totalCreditos}</strong> 
                          ...
                          <AlertDialogContent> 
                            ...
                            <AlertDialogHeader> 
                              ...
                              <AlertDialogDescription> 
                                ...
                                Estás a punto de retirarte de{" "} 

                                <strong> 

                                  {i.materia?.codigo} - {i.materia?.nombre} 

                                </strong> 

                                . Esta acción es permanente y no podrás 

                                volver a inscribirte en esta materia. 
