...
export default function UsuariosTable() { 
    ...
    useEffect(() => {
      fetch("/api/admin/usuarios")
        ...
        .then(({ res, data }) => {
          if (!res.ok) toast.error(data.error || "Error al cargar usuarios");
    ...
    const toggleActivo = async (id: string, estadoActual: boolean) => { 
     ...
     // Helper para color del badge de rol 
    ...
    const badgeRol = (rol: string) => { 
      ...
      return ( 
        ...
        <Badge variant={variantes[rol] || "outline"}> 
                            ...
                            <AlertDialogHeader> 
                              ...
                              <AlertDialogDescription> 
                                ...
                                {u.activo 
                                  ...
                                  ? `${u.nombre_completo} no podrá iniciar sesión.`
                                  : `${u.nombre_completo} podrá acceder nuevamente.`} 
